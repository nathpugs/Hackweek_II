...
class EnviroFacts_DesignForEnvironment_AdvancedSearch_Inputs extends Temboo_Inputs
{
   /**
     ...
     *
     * @param string $value (conditional, string) Indicate the product, code, or sector to search for. Used together with SearchType and the optional Operator input to create a customized search.
     * @return EnviroFacts_DesignForEnvironment_AdvancedSearch_Inputs For method chaining.
     */
