...
class Utilities_Email_SendEmail_Inputs extends Temboo_Inputs
{
   /**
     ...
     *
     * @param int $value (required, integer) Specify the port number (e.g., 25, 465, 587).
     * @return Utilities_Email_SendEmail_Inputs For method chaining.
     */
     ...
     *
     * @param bool $value (optional, boolean) Set to 1 to connect over SSL. Set to 0 for no SSL or to enable TLS. Defaults to 1.
     * @return Utilities_Email_SendEmail_Inputs For method chaining.
     */
...
class Utilities_HTTP_Post_Inputs extends Temboo_Inputs
{
   /**
    ...
    /**
     * Set the value for the EncodedData input for this Post Choreo.
     *
     * @param string $value (optional, multiline) The Base64 encoded content of a file that should be specified as the request body. This input should be used instead of the RequestBody input when posting binary data.
     * @return Utilities_HTTP_Post_Inputs For method chaining.
     */
    public function setEncodedData($value)
    {
        return $this->set('EncodedData', $value);
    }

    /**
     * Set the value for the RequestBody input for this Post Choreo.
     *
     * @param string $value (optional, multiline) The request body for the POST. This input is used when the request body is text e.g. application/json, application/xml, plain/text, etc. Use the EncodedData input when posting binary.
     * @return Utilities_HTTP_Post_Inputs For method chaining.
     */
