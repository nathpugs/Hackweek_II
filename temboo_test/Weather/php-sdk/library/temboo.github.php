...
class GitHub_GitDataAPI_Commits_GetCommit_Inputs extends Temboo_Inputs
{
   /**
     ...
     *
     * @param string $value (required, string) The GitHub account owner.
     * @return GitHub_GitDataAPI_Commits_GetCommit_Inputs For method chaining.
     */
    public function setUser($value)
    {
 ...
 * @subpackage GitHub
 */
class GitHub_ReposAPI_Contents_CreateFile extends Temboo_Choreography
{
    /**
     * Creates a new file in a repository.
     *
     * @param Temboo_Session $session The session that owns this CreateFile Choreo.
     * @return GitHub_ReposAPI_Contents_CreateFile New instance.
     */
    public function __construct(Temboo_Session $session)
    {
        parent::__construct($session, '/Library/GitHub/ReposAPI/Contents/CreateFile/');
    }

    /**
     * Executes this Choreo.
     *
     * Execution object provides access to results appropriate for this CreateFile Choreo.
     *
     * @param GitHub_ReposAPI_Contents_CreateFile_Inputs|array $inputs (optional) Inputs as GitHub_ReposAPI_Contents_CreateFile_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
     * @return GitHub_ReposAPI_Contents_CreateFile_Execution New execution object.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occur in synchronous execution or execution fails to start. NOT thrown for post-launch errors in asynchronous execution -- check status or results to determine asynchronous success.
     * @throws Temboo_Exception_Notfound if choreography does not exist.
     * @throws Temboo_Exception if execution request fails.
    ...
    public function execute($inputs = array(), $async = false, $store_results = true)
    {
        return new GitHub_ReposAPI_Contents_CreateFile_Execution($this->session, $this, $inputs, $async, $store_results);
    }

    /**
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this CreateFile Choreo.
     *
     * @param array $inputs (optional) Associative array of input names and values.
     * @return GitHub_ReposAPI_Contents_CreateFile_Inputs New inputs object.
     * @throws Temboo_Exception if provided input set is invalid. (Note an empty set is considered valid.)
     */
    public function newInputs($inputs = array())
    {
        return new GitHub_ReposAPI_Contents_CreateFile_Inputs($inputs);
    }
}


/**
 * Inputs object with appropriate setters for the CreateFile Choreo.
 *
 * @package Temboo
 * @subpackage GitHub
 */
class GitHub_ReposAPI_Contents_CreateFile_Inputs extends Temboo_Inputs
{
   /**
     * Inputs object with appropriate setters for the CreateFile Choreo.
     *
     * @param array $inputs (optional) Associative array of input names and values.
     * @return GitHub_ReposAPI_Contents_CreateFile_Inputs New instance.
     * @throws Temboo_Exception if provided input set is invalid. (Note an empty set is considered valid.)
     */
    public function __construct($inputs = array())
    {
    ...
    /**
     * Set arbitrary input this CreateFile input set.
     *
     * Input names are case sensitive.
     *
     * @param string $name Input name.
     * @param string $value Input value.
     * @return GitHub_ReposAPI_Contents_CreateFile_Inputs For method chaining.
     */
    public function set($name, $value)
    {
        return parent::set($name, $value);
    ...
    /**
     * Set the value for the AccessToken input for this CreateFile Choreo.
     *
     * @param string $value (required, string) The Access Token retrieved during the OAuth process.
     * @return GitHub_ReposAPI_Contents_CreateFile_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Branch input for this CreateFile Choreo.
     *
     * @param string $value (optional, string) The branch name. Default: the repository’s default branch (usually master)
     * @return GitHub_ReposAPI_Contents_CreateFile_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Content input for this CreateFile Choreo.
     *
     * @param string $value (required, string) The new file content, Base64 encoded.
     * @return GitHub_ReposAPI_Contents_CreateFile_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Contributer input for this CreateFile Choreo.
     *
     * @param string $value (optional, string) The type of contributer: committer (the default) or author.
     * @return GitHub_ReposAPI_Contents_CreateFile_Inputs For method chaining.
     */
    public function setContributer($value)
    {
        return $this->set('Contributer', $value);
    }

    /**
     * Set the value for the Email input for this CreateFile Choreo.
     *
     * @param string $value (optional, string) The email of the author (or committer) of the commit.
     * @return GitHub_ReposAPI_Contents_CreateFile_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Message input for this CreateFile Choreo.
     *
     * @param string $value (required, string) The commit message.
     * @return GitHub_ReposAPI_Contents_CreateFile_Inputs For method chaining.
     */
    public function setMessage($value)
    {
    ...
    /**
     * Set the value for the Name input for this CreateFile Choreo.
     *
     * @param string $value (optional, string) The name of the author (or committer) of the commit.
     * @return GitHub_ReposAPI_Contents_CreateFile_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Path input for this CreateFile Choreo.
     *
     * @param string $value (required, string) The content path.
     * @return GitHub_ReposAPI_Contents_CreateFile_Inputs For method chaining.
     */
    public function setPath($value)
    {
    ...
    /**
     * Set the value for the Repo input for this CreateFile Choreo.
     *
     * @param string $value (required, string) The name of the repository.
     * @return GitHub_ReposAPI_Contents_CreateFile_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the User input for this CreateFile Choreo.
     *
     * @param string $value (required, string) The GitHub account owner.
     * @return GitHub_ReposAPI_Contents_CreateFile_Inputs For method chaining.
     */
...
/**
 * Execution object for the CreateFile Choreo.
 *
 * @package Temboo
 * @subpackage GitHub
 */
class GitHub_ReposAPI_Contents_CreateFile_Execution extends Temboo_Choreography_Execution
{
    /**
     * Execution object for the CreateFile Choreo.
     *
     * @param Temboo_Session $session The session that owns this CreateFile execution.
     * @param GitHub_ReposAPI_Contents_CreateFile $choreo The choreography object for this execution.
     * @param GitHub_ReposAPI_Contents_CreateFile_Inputs|array $inputs (optional) Inputs as GitHub_ReposAPI_Contents_CreateFile_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
     * @return GitHub_ReposAPI_Contents_CreateFile_Execution New execution.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occur in synchronous execution or execution fails to start. NOT thrown for post-launch errors in asynchronous execution -- check status or results to determine asynchronous success.
     * @throws Temboo_Exception_Notfound if choreography does not exist.
     */
    public function __construct(Temboo_Session $session, GitHub_ReposAPI_Contents_CreateFile $choreo, $inputs = array(), $async = false, $store_results = true)
    {
        parent::__construct($session, $choreo, $inputs, $async, $store_results);
    }
     ...
     * Obtains a new results object.
     *
     * Includes getters appropriate for this CreateFile execution.
     *
     * @return GitHub_ReposAPI_Contents_CreateFile_Results New results object.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occurred in asynchronous execution.
     * @throws Temboo_Exception_Notfound if execution does not exist.
     * @throws Temboo_Exception if result request fails.
    ...
    /**
     * Wraps results in appropriate results class for this CreateFile execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return GitHub_ReposAPI_Contents_CreateFile_Results New results object.
     */
    protected function wrapResults($outputs)
    {
        return new GitHub_ReposAPI_Contents_CreateFile_Results($outputs);
    }
}


/**
 * Results object with appropriate getters for the CreateFile Choreo.
 *
 * @package Temboo
 * @subpackage GitHub
 */
class GitHub_ReposAPI_Contents_CreateFile_Results extends Temboo_Results
{
    /**
     * Results object with appropriate getters for the CreateFile Choreo.
     *
     * @param array $outputs (optional) Associative array of output names and values.
     * @return GitHub_ReposAPI_Contents_CreateFile_Results New instance.
     * @throws Temboo_Exception if provided output set is invalid. (Note an empty set is considered valid.)
     */
    public function __construct($outputs = array())
    {
    ...
    /**
     * Retrieve the value for the "Limit" output from this CreateFile execution.
     *
     * @return int (integer) The available rate limit for your account. This is returned in the GitHub response header.
     * @throws Temboo_Exception_Notfound if output does not exist. (Note an empty response is considered valid.)
     */
    ...
    /**
     * Retrieve the value for the "Remaining" output from this CreateFile execution.
     *
     * @return int (integer) The remaining number of API requests available to you. This is returned in the GitHub response header.
     * @throws Temboo_Exception_Notfound if output does not exist. (Note an empty response is considered valid.)
     */
    ...
    /**
     * Retrieve the value for the "Response" output from this CreateFile execution.
     *
 ...
 * @subpackage GitHub
 */
class GitHub_ReposAPI_Contents_DeleteFile extends Temboo_Choreography
{
    /**
     * Deletes a file in a repository.
     *
     * @param Temboo_Session $session The session that owns this DeleteFile Choreo.
     * @return GitHub_ReposAPI_Contents_DeleteFile New instance.
     */
    public function __construct(Temboo_Session $session)
    {
        parent::__construct($session, '/Library/GitHub/ReposAPI/Contents/DeleteFile/');
    }
     ...
     *
     * @param GitHub_ReposAPI_Contents_DeleteFile_Inputs|array $inputs (optional) Inputs as GitHub_ReposAPI_Contents_DeleteFile_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
     * @return GitHub_ReposAPI_Contents_DeleteFile_Execution New execution object.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occur in synchronous execution or execution fails to start. NOT thrown for post-launch errors in asynchronous execution -- check status or results to determine asynchronous success.
     * @throws Temboo_Exception_Notfound if choreography does not exist.
     * @throws Temboo_Exception if execution request fails.
    ...
    public function execute($inputs = array(), $async = false, $store_results = true)
    {
        return new GitHub_ReposAPI_Contents_DeleteFile_Execution($this->session, $this, $inputs, $async, $store_results);
    }
     ...
     *
     * @param array $inputs (optional) Associative array of input names and values.
     * @return GitHub_ReposAPI_Contents_DeleteFile_Inputs New inputs object.
     * @throws Temboo_Exception if provided input set is invalid. (Note an empty set is considered valid.)
     */
    public function newInputs($inputs = array())
    {
        return new GitHub_ReposAPI_Contents_DeleteFile_Inputs($inputs);
    }
}
 ...
 * @subpackage GitHub
 */
class GitHub_ReposAPI_Contents_DeleteFile_Inputs extends Temboo_Inputs
{
   /**
     * Inputs object with appropriate setters for the DeleteFile Choreo.
     *
     * @param array $inputs (optional) Associative array of input names and values.
     * @return GitHub_ReposAPI_Contents_DeleteFile_Inputs New instance.
     * @throws Temboo_Exception if provided input set is invalid. (Note an empty set is considered valid.)
     */
    public function __construct($inputs = array())
    {
     ...
     * @param string $name Input name.
     * @param string $value Input value.
     * @return GitHub_ReposAPI_Contents_DeleteFile_Inputs For method chaining.
     */
    public function set($name, $value)
    {
        return parent::set($name, $value);
    ...
    /**
     * Set the value for the Branch input for this DeleteFile Choreo.
     *
     * @param string $value (optional, string) The branch name. Default: the repository’s default branch (usually master)
     * @return GitHub_ReposAPI_Contents_DeleteFile_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Contributer input for this DeleteFile Choreo.
     *
     * @param string $value (optional, string) The type of contributer: committer (the default) or author.
     * @return GitHub_ReposAPI_Contents_DeleteFile_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Email input for this DeleteFile Choreo.
     *
     * @param string $value (optional, string) The email of the author (or committer) of the commit.
     * @return GitHub_ReposAPI_Contents_DeleteFile_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Message input for this DeleteFile Choreo.
     *
     * @param string $value (required, string) The commit message.
     * @return GitHub_ReposAPI_Contents_DeleteFile_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Name input for this DeleteFile Choreo.
     *
     * @param string $value (optional, string) The name of the author (or committer) of the commit.
     * @return GitHub_ReposAPI_Contents_DeleteFile_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Path input for this DeleteFile Choreo.
     *
     * @param string $value (required, string) The content path.
     * @return GitHub_ReposAPI_Contents_DeleteFile_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Repo input for this DeleteFile Choreo.
     *
     * @param string $value (required, string) The name of the repository.
     * @return GitHub_ReposAPI_Contents_DeleteFile_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Sha input for this DeleteFile Choreo.
     *
     * @param string $value (required, string) The blob SHA of the file being deleted.
     * @return GitHub_ReposAPI_Contents_DeleteFile_Inputs For method chaining.
     */
    public function setSha($value)
    {
    ...
    /**
     * Set the value for the User input for this DeleteFile Choreo.
     *
     * @param string $value (required, string) The GitHub account owner.
     * @return GitHub_ReposAPI_Contents_DeleteFile_Inputs For method chaining.
     */
 ...
 * @subpackage GitHub
 */
class GitHub_ReposAPI_Contents_DeleteFile_Execution extends Temboo_Choreography_Execution
{
    /**
     * Execution object for the DeleteFile Choreo.
     *
     * @param Temboo_Session $session The session that owns this DeleteFile execution.
     * @param GitHub_ReposAPI_Contents_DeleteFile $choreo The choreography object for this execution.
     * @param GitHub_ReposAPI_Contents_DeleteFile_Inputs|array $inputs (optional) Inputs as GitHub_ReposAPI_Contents_DeleteFile_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
     * @return GitHub_ReposAPI_Contents_DeleteFile_Execution New execution.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occur in synchronous execution or execution fails to start. NOT thrown for post-launch errors in asynchronous execution -- check status or results to determine asynchronous success.
     * @throws Temboo_Exception_Notfound if choreography does not exist.
     */
    public function __construct(Temboo_Session $session, GitHub_ReposAPI_Contents_DeleteFile $choreo, $inputs = array(), $async = false, $store_results = true)
    {
        parent::__construct($session, $choreo, $inputs, $async, $store_results);
    }
     ...
     *
     * @return GitHub_ReposAPI_Contents_DeleteFile_Results New results object.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occurred in asynchronous execution.
     * @throws Temboo_Exception_Notfound if execution does not exist.
     * @throws Temboo_Exception if result request fails.
    ...
    protected function wrapResults($outputs)
    {
        return new GitHub_ReposAPI_Contents_DeleteFile_Results($outputs);
    }
}
 ...
 * @subpackage GitHub
 */
class GitHub_ReposAPI_Contents_DeleteFile_Results extends Temboo_Results
{
    /**
     * Results object with appropriate getters for the DeleteFile Choreo.
     *
     * @param array $outputs (optional) Associative array of output names and values.
     * @return GitHub_ReposAPI_Contents_DeleteFile_Results New instance.
     * @throws Temboo_Exception if provided output set is invalid. (Note an empty set is considered valid.)
     */
    public function __construct($outputs = array())
    {
    ...
    /**
     * Retrieve the value for the "Limit" output from this DeleteFile execution.
     *
     * @return int (integer) The available rate limit for your account. This is returned in the GitHub response header.
     * @throws Temboo_Exception_Notfound if output does not exist. (Note an empty response is considered valid.)
     */
    ...
    /**
     * Retrieve the value for the "Remaining" output from this DeleteFile execution.
     *
     * @return int (integer) The remaining number of API requests available to you. This is returned in the GitHub response header.
     * @throws Temboo_Exception_Notfound if output does not exist. (Note an empty response is considered valid.)
     */
