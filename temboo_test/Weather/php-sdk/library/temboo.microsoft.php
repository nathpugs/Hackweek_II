...
class Microsoft_OAuth_FinalizeOAuth_Inputs extends Temboo_Inputs
{
   /**
     ...
     *
     * @param string $value (conditional, string) The App ID URI of the web API (secured resource). See Choreo notes for details. This can be left blank when using the Excel API.
     * @return Microsoft_OAuth_FinalizeOAuth_Inputs For method chaining.
     */
...
class Microsoft_OAuth_InitializeOAuth_Inputs extends Temboo_Inputs
{
   /**
     ...
     *
     * @param string $value (conditional, string) The App ID URI of the web API (secured resource). See Choreo notes for details. Used for PowerBI only.
     * @return Microsoft_OAuth_InitializeOAuth_Inputs For method chaining.
     */
    public function setResource($value)
    {
     ...
     *
     * @param string $value (conditional, string) A space-delimited list of the permissions that the user must accept e.g. Files.ReadWrite. Used for Excel only.
     * @return Microsoft_OAuth_InitializeOAuth_Inputs For method chaining.
     */
