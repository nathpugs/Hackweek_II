...
class NYTimes_MovieReviews_GetReviewer_Inputs extends Temboo_Inputs
{
   /**
     ...
     *
     * @param string $value (optional, string) Specify "all", "full-time", or "part-time" for that subset. Specify a reviewer's name to get details about a reviewer (e.g. Manohla Dargis).
     * @return NYTimes_MovieReviews_GetReviewer_Inputs For method chaining.
     */
    public function setResourceType($value)
    {
...
class NYTimes_MovieReviews_SearchByKeyword_Inputs extends Temboo_Inputs
{
   /**
     ...
     *
     * @param string $value (optional, string) Limits results to reviews by a specific critic.
     * @return NYTimes_MovieReviews_SearchByKeyword_Inputs For method chaining.
     */
...
class NYTimes_MovieReviews_SearchByReviewer_Inputs extends Temboo_Inputs
{
   /**
    ...
    /**
     * Set the value for the Limit input for this SearchByReviewer Choreo.
     *
     * @param string $value (optional, string) The number of results to return.
     * @return NYTimes_MovieReviews_SearchByReviewer_Inputs For method chaining.
     */
    public function setLimit($value)
    {
     ...
     *
     * @param string $value (required, string) Limits results to reviews by a specific critic.
     * @return NYTimes_MovieReviews_SearchByReviewer_Inputs For method chaining.
     */
